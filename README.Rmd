...
```{r load_data}
df <- read_csv('output/normal/hsapiens_infected_with_tcruzi-uninf-v6.0.csv') %>%
    filter(network_type == 'signed')
```
...
```{r load_data}
df <- read_csv('output/normal/hsapiens_infected_with_lmajor-uninf-v6.0.csv') %>%
    filter(network_type == 'signed')
```
...
```{r load_data}
df <- read_csv('output/normal/lmajor_all_samples-multicopy-v6.0.csv') %>%
    filter(network_type == 'signed')
```
...
```{r load_data}
df <- read_csv('output/normal/tcruzi_all_samples-multicopy-v6.0.csv') %>%
    filter(network_type == 'signed')
```
